       ...
       <div className='uk-margin-large-top'>
         <div className="hidden-sm hidden-xs col-lg-6 col-md-6  col-sm-6 ">
            <div>
                ...
                <img src={fb} style={{width:333, height:333}}/>
              ...
              <img src={chevronsR} style={{height:16, width:16}} />
              </span></div> 
            </div>
        ...
        <div className="hidden-lg hidden-md col-lg-6 col-md-6  col-sm-6 ">
            <div>
                ...
                <img src={fb} style={{width:121, height:121}}/>
        ...
        <div className=" hidden-sm hidden-xs col-lg-6 col-md-6  col-sm-6 ">
            ...
            <img src={whatsapp} style={{width:333, height:333}}/>
        ...
        <div className="hidden-lg hidden-md  col-lg-6 col-md-6  col-sm-6 ">
            ...
            <img src={whatsapp} style={{width:121, height:121}}/>
