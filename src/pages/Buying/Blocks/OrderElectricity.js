   ...
   await Validation()
    ...
    if(validated === true){
      if(paymentmode == "wallet"){
       ...
       Showerror()
        setVisible(true)
        setError("you do not have sufficient funds in your wallet")
     }else{
    ...
    await axios.post("/api/v2/verify_meter", payload).then(res => {
     ...
     // }
      ...
      // }else{
      //   if(validated == false || paymentmode == "card"){
      //     alert("card was selected")
      //   }else{
...
{validated}
                  ...
                  <div class="uk-form-controls" >
                   ...
                   <div  className="" style={{fontSize:30, fontFamily: "Dongle", fontWeight:'300'}}> How much electricity do you want to buy?</div>
                    <div class="uk-margin">
                   ...
                   <div className="" style={{fontSize:30, fontFamily: "Dongle", fontWeight:'300'}}>Select your payment mode</div>
                   <div  class="uk-margin">
                   
                  <div class="uk-form-controls" >
                     <select disabled ={loading}  value={paymentmode}   name="product_code" onChange={e => setPaymentmode(e.target.value)}  class="uk-select" id="form-stacked-select" style={{borderRadius:5, fontSize:22, color:'#22292E',fontFamily: "Dongle", fontWeight:'300', lineHeight:2}}>
